"""
Plot GCN vs GPS comparison: mean ± std across 4 seeds for MCDO + PMA.
Saves figures/gcn_vs_gps_mcdo_pma.png
"""
...
LOG_DIR    = 'logs'
OUTPUT     = 'figures/gcn_vs_gps_mcdo_pma.png'
...
fig.suptitle('GCN vs GPS — PMA + MCDO (mean ± std, 4 seeds)',
