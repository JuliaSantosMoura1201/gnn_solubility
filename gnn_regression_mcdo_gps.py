...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_heads', type=int, default=4,
                        help='Number of attention heads in GPS and PMA')
    parser.add_argument('--out_dim', type=int, default=2,
                        help='Output dimension (2 for heteroscedastic loss)')
    parser.add_argument('--readout', type=str, default='pma',
                        help='Graph readout: sum, mean, max, pma')
    parser.add_argument('--dropout_prob', type=float, default=0.2,
                        help='Dropout probability (used for MC-Dropout)')
    parser.add_argument('--norm_features', type=str2bool, default=False,
                        help='Whether to normalise features at PMA step')
    parser.add_argument('--local_mp_type', type=str, default='gin',
                        help='Local MP module inside GPS: gin or gcn')
    parser.add_argument('--rwse_k', type=int, default=16,
                        help='Number of RWSE random-walk steps; 0 to disable')
    ...
    parser.add_argument('--num_sampling', type=int, default=10,
                        help='Number of MC-Dropout forward passes at inference')
